            ...
            <div class="box box-primary">
                ...
                <div id="panel-store" class="box-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label for="input-name">Payment Type:</label>
                            <input type="text" required disabled class="form-control" value="{{ $jobOrder->payment_type }}">
                        </div>
                        ...
                        <div class="bootstrap-timepicker">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="hidden" name="estimated_time_of_completion" value="{{ $jobOrder->estimated_time_of_completion }}">
                                    <input id="estimated-time-timepicker" type="text" class="form-control timepicker">
